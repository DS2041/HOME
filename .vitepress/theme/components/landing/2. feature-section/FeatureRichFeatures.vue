...
import logoJSON from './images/code.svg'
import logoCSS from './images/btc.svg'
import logoJS from './images/book.svg'
import logoTS from './images/program.svg'
import logoWA from './images/music.svg'
import logoPostCSS from './images/math.svg'
...
<template>
  ...
  >
    ...
    <div class="feature__meta meta--center">
      <div class="meta__title">3. Education</div>
      <div class="meta__description">
        Digital doors to every subject.
      </div>
    </div>
  </div>
</template>
